...
<div class="under-line">
    <div class="link__container">
        <div class="detail">
            <a class="unselected__link" href="/item/{{ $item['id'] }}">商品説明</a>
        </div>
        <div class="comment">
            <a class="selected__link" href="/comment/{{ $item['id'] }}">コメント</a>
        </div>
    </div>
</div>
<div class="main__container">
    ...
    <div class="info__container">
        ...
        <div class="comment__container">
            <div class="comment-name__container">
                <div class="member-icon">
                    @if( !empty($comment->user->image) )
                    <img class="member-icon__img" src="{{ $comment['user']['image'] }}">
                    @else
                    <svg xmlns="http://www.w3.org/2000/svg" height="18" width="18" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
        ...
        @endforeach
        <form action="/comment?id={{ $item['id'] }}" method="POST">
            @csrf
            <div class="item-comment__container">
                <div class="item-heading">
                    商品へのコメント
                </div>
